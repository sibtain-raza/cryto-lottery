...
const Home: NextPage = () => {
  ...
  const { data: CurrentWinningReward, isLoading } = useContractRead(contract, "CurrentWinningReward")
      ...
      <div className="flex-1">
        ...
        <Marquee className="bg-[#0A1F1C] p-5 mb-5" gradient={false} speed={100}>
          <div className='flex space-x-10 mx-10'>
            <h4 className='text-white font-bold'>LastWinner:{lastWinner?.toString()}</h4>
        ...
        {winnings > 0 && (
          <div className='max-w-md md:max-w-2xl lg:max-w-4xl mx-auto mt-5'>
            <button
              ...
              className='p-5 bg-slate-400 text-white animate-pulse text-center rounded-xl w-full '>
